...
* 2. Declare a function that will get value from the class SkillCategory.
...
class SkillCategoryAssembler
{
 ...
 /**@fn assemble.
  * @brief Gets value from the class SkillCategory.
  * @param Reference to the object of the class SkillCategory and std::string.
  * @return std::string.
  */

	  static std::string assemble(SkillCategory& category,std::string query);
